...
export function CatIcon({ name, color, size = 18 }: CatIconProps) {
  const st: React.CSSProperties = { width:size, height:size, display:"block", flexShrink:0, fill:"none", stroke:color, strokeWidth:1.8, strokeLinecap:"round", strokeLinejoin:"round" };
